                ...
                <UiAccordion>
                  ...
                  <template #content>
                    ...
                    <UiParagraph>
                      ...
                      вызывает адреналин и бурю эмоций. Такие люди сосредоточены на процессе, а не
                      на последствиях. Пример – Дима, который занимается экстремальными видами
                      спорта ради эмоций, хотя иногда недооценивает риски. В минимальной форме это
                      может быть просмотр экстремальных видео. Биохимия мозга: высокий тестостерон,
                      колебания адреналина, низкий кортизол.
                    </UiParagraph>
                    ...
                    <UiParagraph>
                      ...
                      помогает в делах, требующих точности, как у скульптора. Биохимия мозга:
                      дофамин, γ-аминомасляная кислота, δ-опиоидный рецептор.
                    </UiParagraph>
                    <UiHeading variant="h2"> Социально-вербальный темп </UiHeading>
                    <UiParagraph>
                      Социально-вербальный темп – это скорость, с которой человек общается и
                      понимает речь. Пример – Лена, которая быстро обсуждает видео с друзьями и
                      предугадывает, о чём говорят персонажи в сериале. Высокий темп помогает в
                      быстром общении, но может приводить к пропуску деталей. Биохимия мозга:
                      эстроген, нейропептиды под контролем дофамина.
                    </UiParagraph>
                    <UiHeading variant="h2"> Пластичность </UiHeading>
                    <UiParagraph>
                      Пластичность – это способность адаптироваться к новым ситуациям. Пример –
                      Алекс, который легко переключается между задачами, но иногда бывает
                      непоследовательным. Минимальная пластичность помогает сосредотачиваться на
                      одной задаче, но может затруднять адаптацию к изменениям. Биохимия мозга:
                      дофамин, ацетилхолин, γ-аминомасляная кислота.
                    </UiParagraph>
                    <UiHeading variant="h2"> Физическая выносливость </UiHeading>
                    <UiParagraph>
                      Физическая выносливость – это способность долго выполнять физические
                      упражнения без усталости. Пример – Ваня, который может долго бегать или играть
                      в футбол. Выносливость может быть долгосрочной, как у марафонца, или
                      интенсивной, как у гимнаста. Биохимия мозга: серотонин, орексины,
                      нейропептиды, гистамин.
                    </UiParagraph>
                    ...
                    <UiParagraph>
                      ...
                      уставая. Пример – человек, который может часами беседовать, оставаясь
                      интересным собеседником. Это важно в социальных ситуациях и помогает заводить
                      друзей и быть успешным. Биохимия мозга: эстроген, гистамин, дофамин,
                      серотонин.
                    </UiParagraph>
                    ...
                    <UiParagraph>
                      Невротизм – это склонность избегать стрессовых ситуаций. Люди с высоким
                      уровнем невротизма предпочитают предсказуемость и избегают риска. Пример –
                      Женя, который избегает новых ситуаций из-за страха перед неизвестным. Люди с
                      низким уровнем невротизма легче справляются с неопределённостью. Биохимия
                      мозга: опиоидные k-рецепторы, цитокины, микробиота кишечника, норадреналин.
                    </UiParagraph>
                    <UiHeading variant="h2"> Импульсивность </UiHeading>
                    <UiParagraph>
                      Импульсивность – это склонность действовать под влиянием эмоций без
                      обдумывания последствий. Пример – человек, который быстро принимает решения в
                      экстренных ситуациях. Высокая импульсивность полезна для быстрого
                      реагирования, низкая – для обдуманных действий.Биохимия мозга: опиоидные
                      δ-рецепторы, дофамин.
                    </UiParagraph>
